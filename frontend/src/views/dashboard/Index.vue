...
const users = ref([
  ...
  { id: 3, name: 'Charlie', email: 'charlie@example.com', status: true },
  { id: 3, name: 'Charlie', email: 'charlie@example.com', status: true },
  { id: 3, name: 'Charlie', email: 'charlie@example.com', status: true },
  { id: 3, name: 'Charlie', email: 'charlie@example.com', status: true },
